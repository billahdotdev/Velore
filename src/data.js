// ─── data.js — VELOUR Romance & Intimacy Store ─────────────────────────────
// ⚠️  Replace ALL entry.XXXXXXXXX values with your actual Google Form field IDs
//     To find them: preview your form → right-click any input → Inspect → name="entry.XXXXXXXX"
//
// ─── Analytics / Tracking ──────────────────────────────────────────────────
// PIXEL_ID:     Your Meta (Facebook) Pixel ID
// GTM_ID:       Your Google Tag Manager container ID  (GTM-XXXXXXX)
// GA4_ID:       Your GA4 Measurement ID               (G-XXXXXXXXXX)
// CAPI_TOKEN:   Meta Conversions API access token (server-side events)
// CAPI_PIXEL:   Same as PIXEL_ID — used for CAPI calls
// TT_PIXEL:     TikTok Pixel ID (optional)
// SNAP_PIXEL:   Snapchat Pixel ID (optional)

export const TRACKING = {
  PIXEL_ID:   "YOUR_META_PIXEL_ID",       // Meta Pixel
  GTM_ID:     "GTM-XXXXXXX",              // Google Tag Manager
  GA4_ID:     "G-XXXXXXXXXX",             // Google Analytics 4
  CAPI_TOKEN: "YOUR_CAPI_ACCESS_TOKEN",   // Meta Conversions API token
  CAPI_PIXEL: "YOUR_META_PIXEL_ID",       // Same as PIXEL_ID
  TT_PIXEL:   "YOUR_TIKTOK_PIXEL_ID",     // TikTok Pixel (optional)
  SNAP_PIXEL: "YOUR_SNAPCHAT_PIXEL_ID",   // Snapchat Pixel (optional)
};
...
export const STORE = {
  ...
  currency: "BDT",
  whatsapp: "8801XXXXXXXXX", // Your WhatsApp number with country code
